...
|--------------|---------------------------------------|--------------------------|--------------------------------------------------------------------------------------------------|----------------------------------------|---------------------------------------------------------------------------------|-------------------------------------------------------------------------------|--------|
| TC_01        | New user record inserted in database  | -                        | 1. Go to the Home Page<br>2. Go to the Login Page<br>3. Go to sign-up page<br>4. Fill Details    | Give the user’s Name, Email ID, and Password | The user’s record is inserted into the database and redirected to the login page | The user’s record is inserted into the database and redirected to the login page | PASS   |
| TC_02        | Login in user                         | Users have a profile     | 1. Go to the Home Page<br>2. Go to the Login Page<br>3. Fill Details                             | Give User’s Email and Password         | User login successfully                                                        | User login successfully                                                        | PASS   |
