...
const Contact = () => {
  return (
    <div style={{ display: 'flex', width: '100vw', height: '100vh', background: '#FCFDFD' }}>
      ...
      <div style={{ background: '#FCFDFD', width: '50vw', height: '100vh', padding: '5rem 3.5rem' }}>
        ...
        <form id="contact-form" method="post" style={{ width: '31.25rem', position: 'relative', marginTop: '2rem', padding: '1rem 0' }}>
          ...
          <textarea rows="6" placeholder="Your Message" id="message" name="message" required style={{ color: '#010712', fontWeight: 500, background: '#FCFDFD', border: 'none', borderBottom: '1px solid #818386', padding: '0.5rem 0', marginBottom: '1rem', outline: 'none', width: '40vw', resize: 'none' }}></textarea>
        ...
        <div id="error" style={{ width: '40vw', margin: '0.125rem 0', fontSize: '0.75rem', textTransform: 'uppercase', fontFamily: 'Jost', color: '#818386' }}></div>
