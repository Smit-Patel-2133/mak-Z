                ...
                <form
                    ...
                    <div className="mt-8 w-full">
                        ...
                        <input type="email" id="email" name="email" placeholder="Email address"
                               ...
                               className="justify-center px-3 py-2.5 w-full text-gray-900 bg-white rounded-md border border-gray-300"/>
                    </div>
                    ...
                    <div className="flex gap-5 justify-between mt-6 w-full">
                        ...
                        <button className="font-medium text-rose-500 focus:outline-none focus:underline"
                                tabIndex="0">Forgot your password?
                        </button>
                    </div>
                    <button type="submit"
                            className="flex justify-center items-center px-16 py-2.5 mt-6 w-full font-medium text-white bg-rose-500 rounded-md focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-rose-500"
                            tabIndex="0">Sign in
                    </button>
                </form>
            </div>
